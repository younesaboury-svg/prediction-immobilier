...
def render_dashboard(categories_info: list) -> None:
    ...
    with col_left:
        ...
        rows_html = "".join(
            ...
            <div class="rank-row">
                <div>
                    <span class="rank-name">{q['quartier']}</span><br/>
                    <span class="rank-meta">{q['n_annonces']} annonces</span>
                </div>
                <span class="rank-value">{fmt_dh(q['prix_m2_median'])} DH/m²</span>
            </div>
            """
            for q in top_prix
        )
    ...
    with col_right:
        ...
        rows_html = "".join(
            ...
            <div class="rank-row">
                <div>
                    <span class="rank-name">{q['quartier']}</span><br/>
                    <span class="rank-meta">{fmt_dh(q['prix_m2_median'])} DH/m²</span>
                </div>
                <span class="rank-value">{q['n_annonces']}</span>
            </div>
            """
            for q in top_volume
        )
